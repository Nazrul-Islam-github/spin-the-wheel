...
import DeskTopWheel from "./DesktopWheel";
      ...
      <div className={Style.Main}>
        ...
        <div className={Style.Hero1}>
          <div className={Style.Content}>
            ...
            <h1
              style={{
                color: nightMode ? "var(--bs-light)" : "var(--bs-dark)",
              }}
            >
            Spin The Wheel
            </h1>
          ...
          <div className={Style.Setting}>
            <svg
              ...
              width="48"
              fill={nightMode ? "var(--bs-light)" : "var(--bs-dark)"}
            >
            ...
            <Setting isOpen={openSetting} setopen={setOpenSetting} />
          </div>
        </div>
